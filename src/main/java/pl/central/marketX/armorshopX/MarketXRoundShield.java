...
public class MarketXRoundShield implements PlayerActionState {
    public double RoundShieldPriceX = 120.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy round shields for 120 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=RoundShieldPriceX){
                playerWealth = playerWealth - RoundShieldPriceX;
