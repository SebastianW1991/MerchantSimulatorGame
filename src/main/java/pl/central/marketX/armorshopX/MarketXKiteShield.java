...
public class MarketXKiteShield implements PlayerActionState {
    public double KiteShieldPriceX = 150.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy  kite shields for 150 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=KiteShieldPriceX){
                playerWealth = playerWealth - KiteShieldPriceX;
