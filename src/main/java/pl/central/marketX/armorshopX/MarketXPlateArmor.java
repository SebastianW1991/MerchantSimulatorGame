...
public class MarketXPlateArmor implements PlayerActionState {
    public double PlatePriceX = 1000.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy chest of plate armours for 50 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=PlatePriceX){
                playerWealth = playerWealth - PlatePriceX;
