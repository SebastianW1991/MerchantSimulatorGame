...
public class MarketXChainmail implements PlayerActionState {
    public double ChainmailPriceX = 300.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy chest of chainmails for 50 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=ChainmailPriceX){
                playerWealth = playerWealth - ChainmailPriceX;
