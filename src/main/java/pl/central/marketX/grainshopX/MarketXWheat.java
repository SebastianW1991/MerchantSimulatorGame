...
public class MarketXWheat implements PlayerActionState {
    public double WheatPriceX = 10.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy 10 kg bag of Wheat for 10 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=WheatPriceX){
                playerWealth = playerWealth - WheatPriceX;
