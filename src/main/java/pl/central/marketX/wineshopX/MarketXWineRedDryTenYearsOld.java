...
public class MarketXWineRedDryTenYearsOld implements PlayerActionState {
    public double RedDryTenYearsOldWinePriceX = 120.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy Barrel of Red Dry Ten Years Old Wine for 120 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=RedDryTenYearsOldWinePriceX){
            playerWealth = playerWealth - RedDryTenYearsOldWinePriceX;
