...
public class MarketXPoleaxes implements PlayerActionState {
    public double PoleaxesPriceX = 30.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy chest of axes for 30 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>= PoleaxesPriceX){
                playerWealth = playerWealth - PoleaxesPriceX;
