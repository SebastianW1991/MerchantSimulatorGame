...
public class MarketXArrows implements PlayerActionState {
    public double ArrowsPriceX = 20.0;
    @Override
    public void action(ActionStateContext ctx) {
        System.out.println("You are about to buy barrel of 100 arrows for 20 guldens " +
        ...
        if (playerChoice.equals("a")) {
            if (playerWealth>=ArrowsPriceX){
                playerWealth = playerWealth - ArrowsPriceX;
